...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  k8s-snippets = {
    pname = "k8s-snippets";
    version = "cb90c4a1e0c53b546942d615f7ee738b2e1e1894";
    src = fetchFromGitHub ({
      owner = "budimanjojo";
      repo = "k8s-snippets";
      rev = "cb90c4a1e0c53b546942d615f7ee738b2e1e1894";
      fetchSubmodules = false;
      sha256 = "sha256-iIlvPWQZRhm6b8Sma9iMit1x2dyd1E06NJnmu2CDgRA=";
    });
    date = "2023-04-18";
  };
  luasnip = {
  ...
  mason-lspconfig-nvim = {
    ...
    version = "7034065099c1665143091c7282b3b1b8f0b23783";
    src = fetchFromGitHub ({
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "7034065099c1665143091c7282b3b1b8f0b23783";
      fetchSubmodules = false;
      sha256 = "sha256-SsWIUh7Q9jnYAQN7SOmRyPOPSD6jKR0HzC7FpkwJHKo=";
    });
    date = "2023-04-18";
  };
