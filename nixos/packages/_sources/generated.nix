...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "2d7a2a61221c634391130b86dbebe90b7249e2b1";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "2d7a2a61221c634391130b86dbebe90b7249e2b1";
      fetchSubmodules = false;
      sha256 = "sha256-1WMrNZxyeQVzME8hqZFfLR+CsrU4p3Jdm3TV4+lJrsI=";
    };
    date = "2023-12-01";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "58340545c6a01e5e9f7966df448714a156db137a";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "58340545c6a01e5e9f7966df448714a156db137a";
      fetchSubmodules = false;
      sha256 = "sha256-dxialVv9Zh2VBxdeHGQEuNhbUgCOHuCQRhN7M0Zqfmg=";
    };
    date = "2023-11-30";
  };
