...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "65c53dbe4f2140236590a7568a5f22a77d16be39";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "65c53dbe4f2140236590a7568a5f22a77d16be39";
      fetchSubmodules = false;
      sha256 = "sha256-Mtqfj0P/DqrB5k5QK84o6J5svYNxKLoYiNSnp3vdjg0=";
    };
    date = "2024-06-21";
  };
  ...
  tokyonight-gtk-theme = {
    ...
    version = "49554a119f02b448aa2898e71437c2184b287cb0";
    src = fetchFromGitHub {
      owner = "Fausto-Korpsvart";
      repo = "Tokyo-Night-GTK-Theme";
      rev = "49554a119f02b448aa2898e71437c2184b287cb0";
      fetchSubmodules = false;
      sha256 = "sha256-ijYF1P6ZnlPZRCcWm+6ETf4qatvyFWMCY/MzVxZaLHk=";
    };
    date = "2024-06-26";
  };
