...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "8f9af9bd7dc8599c8ec5826bb175dc871e4b582d";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "8f9af9bd7dc8599c8ec5826bb175dc871e4b582d";
      fetchSubmodules = false;
      sha256 = "sha256-S7KxaRQLEOu++xcoF0bpmibblo3LFm8R/70YSX79/YY=";
    };
    date = "2023-06-12";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "f322209a4a2b4685adeda5df00b29cdfd64db08e";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "f322209a4a2b4685adeda5df00b29cdfd64db08e";
      fetchSubmodules = false;
      sha256 = "sha256-1crrZQ2fx+EDXU6iR+yjDkxmGCr6fMfWzxw8jrcnk+g=";
    };
    date = "2023-06-03";
  };
