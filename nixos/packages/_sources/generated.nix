...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "a81503f0019942111fe464209237f8b4e85f4687";
    src = fetchFromGitHub ({
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "a81503f0019942111fe464209237f8b4e85f4687";
      fetchSubmodules = false;
      sha256 = "sha256-RMh3LZrL8LDje0/pjsGT+q9vPZr5N3PbEc6mZcvyhjE=";
    });
    date = "2023-03-12";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "33ee724c2d25358917147718c3b108a90b571e20";
    src = fetchFromGitHub ({
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "33ee724c2d25358917147718c3b108a90b571e20";
      fetchSubmodules = false;
      sha256 = "sha256-xYPFHYuVl6acttCWcS3DGH76BK2/TUblDLXNB36Z4bc=";
    });
    date = "2023-03-12";
  };
  sad-nvim = {
