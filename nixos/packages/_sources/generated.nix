...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "17a493410c72268a5ec6eb59dc2d6c11bbf424c8";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "17a493410c72268a5ec6eb59dc2d6c11bbf424c8";
      fetchSubmodules = false;
      sha256 = "sha256-29sG3iuNbiPEBd+2jOz4Q25AfCZPqkQhbzUKfEIQRbU=";
    };
    date = "2023-06-29";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "0138a2e0f9baacd98d5531ebb5078fafc5114fae";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "0138a2e0f9baacd98d5531ebb5078fafc5114fae";
      fetchSubmodules = false;
      sha256 = "sha256-XzR315Sgb9SF0KUvCMBGoYgpV4xcBMO1cr1rSvcH5ZA=";
    };
    date = "2023-06-27";
  };
