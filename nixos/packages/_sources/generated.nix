...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  krr = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.3.2";
      fetchSubmodules = false;
      sha256 = "sha256-g+Eus1tRHBef6jjdNj/XP9zrXH3kKmOzcpmvCBfge/8=";
    };
  };
  luasnip = {
    pname = "luasnip";
  ...
  mason-lspconfig-nvim = {
    ...
    version = "828a538ac8419f586c010996aefa5df6eb7c250b";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "828a538ac8419f586c010996aefa5df6eb7c250b";
      fetchSubmodules = false;
      sha256 = "sha256-SsixCboRhb4mnP6f4yAZhkQKI5uVTozk3OyiUaPQgl4=";
    };
    date = "2023-07-14";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "c080379a4de5cfdeccefc39d0d694865ff81c33c";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "c080379a4de5cfdeccefc39d0d694865ff81c33c";
      fetchSubmodules = false;
      sha256 = "sha256-0/b1lfWC4vBdfOqkMWRD63I8/P4ivM1j6HvS9msDg7E=";
    };
    date = "2023-07-14";
  };
