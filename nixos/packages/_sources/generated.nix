...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "e2705063f395b44f676cd26596a11007a2cbd3bd";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "e2705063f395b44f676cd26596a11007a2cbd3bd";
      fetchSubmodules = false;
      sha256 = "sha256-pqaCBOXr79RUjmyqHk7qq69VeQduzUz4tIn2bakoCBI=";
    };
    date = "2023-10-02";
  };
  mason-tool-installer-nvim = {
    pname = "mason-tool-installer-nvim";
    version = "983ec8c8ddd7132083e5ef2a36776cb7b4f43085";
    src = fetchFromGitHub {
      owner = "WhoIsSethDaniel";
      repo = "mason-tool-installer.nvim";
      rev = "983ec8c8ddd7132083e5ef2a36776cb7b4f43085";
      fetchSubmodules = false;
      sha256 = "sha256-gkhjgCFemNFG20vdosTysOgC/hgcObA9AsihqC3EKus=";
    };
    date = "2023-10-09";
  };
  oil-nvim = {
    pname = "oil-nvim";
    version = "f72b9b2637eec2b3db8255c196aa4bf11231af81";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "f72b9b2637eec2b3db8255c196aa4bf11231af81";
      fetchSubmodules = false;
      sha256 = "sha256-sh57E/sp1k0mDgDtrZ8M2hy7dGSD6Ds9FjEpNHmMN+I=";
    };
    date = "2023-10-08";
  };
