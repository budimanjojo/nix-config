...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "48025d62f45af52ba47e4193b854864839392e4c";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "48025d62f45af52ba47e4193b854864839392e4c";
      fetchSubmodules = false;
      sha256 = "sha256-a6D36RGmqXZn+JUzvcuYjkJXhGyA7kdhBs9yKaWjfdg=";
    };
    date = "2023-10-01";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "deba4db1aca6e3970c94499401da001694d01138";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "deba4db1aca6e3970c94499401da001694d01138";
      fetchSubmodules = false;
      sha256 = "sha256-Qkda75PaZIlI69gN2czSWseqWKEatukBVYjjfahyOzY=";
    };
    date = "2023-10-01";
  };
