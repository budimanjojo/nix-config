...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  guihua-lua = {
    pname = "guihua-lua";
    version = "4bfa10464211166052113034402b7dd1d8c409cc";
    src = fetchFromGitHub {
      owner = "ray-x";
      repo = "guihua.lua";
      rev = "4bfa10464211166052113034402b7dd1d8c409cc";
      fetchSubmodules = false;
      sha256 = "sha256-X78hEbGnTyRMn10C8mwzClkgBq4muecqG11mvt/+aXg=";
    };
    date = "2024-05-21";
  };
  k8s-snippets = {
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "06a19f77f1a1da37b675635e6f9c5b5d50bcaacd";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "06a19f77f1a1da37b675635e6f9c5b5d50bcaacd";
      fetchSubmodules = false;
      sha256 = "sha256-FD8g5kEvVs2kj4wy/cEyRPIrnGFdGHHq0knF1VNKz3A=";
    };
    date = "2024-05-17";
  };
