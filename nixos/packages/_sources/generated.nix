...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "397273083f988c1a17acf3816947cd198338e700";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "397273083f988c1a17acf3816947cd198338e700";
      fetchSubmodules = false;
      sha256 = "sha256-DPXp1LNj+vQFhkiqwDI5U3Kwj4JcTUKskv24t6N9dT0=";
    };
    date = "2023-10-11";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "6cbc8d725d3964cb08d679774db67d41fa002647";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "6cbc8d725d3964cb08d679774db67d41fa002647";
      fetchSubmodules = false;
      sha256 = "sha256-0WOf+20VFBlsgKa9rX4hgQOPa6Rvq+TARrnuJx2SVsE=";
    };
    date = "2023-10-10";
  };
