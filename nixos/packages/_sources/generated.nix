...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "05744f0f1967b5757bd05c08df4271ab8ec990aa";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "05744f0f1967b5757bd05c08df4271ab8ec990aa";
      fetchSubmodules = false;
      sha256 = "sha256-y9dYkI28Vnq66A5dUXn1hx6BQsC8dtlkJ6WBIedLg58=";
    };
    date = "2024-05-05";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "3abb6077d7d6b09f5eb794b8764223b3027f6807";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "3abb6077d7d6b09f5eb794b8764223b3027f6807";
      fetchSubmodules = false;
      sha256 = "sha256-aHICzD9JqaYvLwSr7GwbMmZYw6+uCGq0zECtutsf0eQ=";
    };
    date = "2024-05-06";
  };
