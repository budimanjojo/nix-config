...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "9377cda51359011330dc396d967b60159aec75aa";
    src = fetchFromGitHub ({
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "9377cda51359011330dc396d967b60159aec75aa";
      fetchSubmodules = false;
      sha256 = "sha256-4KXdjtEvrJj6JFa6i6sxGvBdLU42Z/cxw4R3EBmxZUQ=";
    });
    date = "2023-05-02";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "82c706822bb13a8ea7a21e0e3dccc83eaf40bfbc";
    src = fetchFromGitHub ({
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "82c706822bb13a8ea7a21e0e3dccc83eaf40bfbc";
      fetchSubmodules = false;
      sha256 = "sha256-eX2AncRs/CDhTK2Vo79RFORpx22fe0PfG9D6XvS3vIQ=";
    });
    date = "2023-04-29";
  };
  sad-nvim = {
