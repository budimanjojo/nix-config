...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "b77ed915ab1e53720a6283702816cea2695a2638";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "b77ed915ab1e53720a6283702816cea2695a2638";
      fetchSubmodules = false;
      sha256 = "sha256-+1kqFQS/ollN+mtBkgxWYRj7onWniHc1FdRcrLrQ6ik=";
    };
    date = "2024-06-13";
  };
  ...
  tokyonight-gtk-theme = {
    ...
    version = "0a2a3d346c8437f81564df20a71c2d5051f1703c";
    src = fetchFromGitHub {
      owner = "Fausto-Korpsvart";
      repo = "Tokyo-Night-GTK-Theme";
      rev = "0a2a3d346c8437f81564df20a71c2d5051f1703c";
      fetchSubmodules = false;
      sha256 = "sha256-kM81ERcjdnhl9vMLeSRXCfEQTwokaBO/j2BzvAgmav8=";
    };
    date = "2024-06-15";
  };
