...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "dfdd771b792fbb4bad8e057d72558255695aa1a7";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "dfdd771b792fbb4bad8e057d72558255695aa1a7";
      fetchSubmodules = false;
      sha256 = "sha256-BbrI05QsYJNDzrMKMzNfGmwzZiC8dmxKMc5KTCzJGTI=";
    };
    date = "2023-08-27";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "7033d52db012666b85504fe9a678939e49bc14b7";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "7033d52db012666b85504fe9a678939e49bc14b7";
      fetchSubmodules = false;
      sha256 = "sha256-h0AeBNX6dKRlNT8ACuvkzUJcwIzM9hiIWNOHTF4sTEU=";
    };
    date = "2023-09-01";
  };
