...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "665bf2edc9f9a6d77a6fc636df36276c97fb5d66";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "665bf2edc9f9a6d77a6fc636df36276c97fb5d66";
      fetchSubmodules = false;
      sha256 = "sha256-nQTRsbcgbhOTInw1e7S5kLjaWMuAWCHQUMp0S0dCjzM=";
    };
    date = "2024-09-11";
  };
  ...
  tokyonight-gtk-theme = {
    ...
    version = "95f659c786d3614b6a31491e4a00926b694edc91";
    src = fetchFromGitHub {
      owner = "Fausto-Korpsvart";
      repo = "Tokyo-Night-GTK-Theme";
      rev = "95f659c786d3614b6a31491e4a00926b694edc91";
      fetchSubmodules = false;
      sha256 = "sha256-GSNG+SpAlvNEVUZ5SPobwr6R3tDiZ5o2EjwyUXBj67Y=";
    };
    date = "2024-09-10";
  };
