...
}:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "fe661093f4b05136437b531e7f959af2a2ae66c8";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "fe661093f4b05136437b531e7f959af2a2ae66c8";
      fetchSubmodules = false;
      sha256 = "sha256-mS+PMT5l+NfEQOFAOIXYXHO4ZZmVxR6gJIpd3g5l5fI=";
    };
    date = "2026-01-10";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "fbbb2a98721da86f46b06994fd3b4833b04c6e9b";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "fbbb2a98721da86f46b06994fd3b4833b04c6e9b";
      fetchSubmodules = false;
      sha256 = "sha256-036i1DtU2Z0gb0Lv+zDLTZ3s00k9FMcM51IwcXWj6xI=";
    };
    date = "2026-01-12";
  };
  tmux-fish = {
