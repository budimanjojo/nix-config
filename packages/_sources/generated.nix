...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-tool-installer-nvim = {
    ...
    version = "98767d37f8e5255a5111fc1e3163232d4dc07bda";
    src = fetchFromGitHub {
      owner = "WhoIsSethDaniel";
      repo = "mason-tool-installer.nvim";
      rev = "98767d37f8e5255a5111fc1e3163232d4dc07bda";
      fetchSubmodules = false;
      sha256 = "sha256-qPVPWYVuxALadX8YRXsouSxEHNnezbZ8H8e9/DzAci8=";
    };
    date = "2025-03-24";
  };
  oil-nvim = {
    pname = "oil-nvim";
    version = "ba1f50a9a81f65c07af584065ab9a5ad2a9e5fe0";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "ba1f50a9a81f65c07af584065ab9a5ad2a9e5fe0";
      fetchSubmodules = false;
      sha256 = "sha256-l8NoqpXThrUMTuRl4EHycZZeVBAXarVgwYuGXdYKk5o=";
    };
    date = "2025-03-30";
  };
  sad-nvim = {
