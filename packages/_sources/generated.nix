...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  mason-lspconfig-nvim = {
    ...
    version = "c2682b0d9732bf52cbc34862056f143e71dc4a6d";
    src = fetchFromGitHub {
      owner = "williamboman";
      repo = "mason-lspconfig.nvim";
      rev = "c2682b0d9732bf52cbc34862056f143e71dc4a6d";
      fetchSubmodules = false;
      sha256 = "sha256-ZhsRcQLNbToGJCp7UhTOnzdq2vxf0kWYc5PpupnoqOk=";
    };
    date = "2025-06-03";
  };
  ...
  oil-nvim = {
    pname = "oil-nvim";
    version = "5b6068aad7d2057dd399fac73b7fb2cdf23ccd6e";
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "5b6068aad7d2057dd399fac73b7fb2cdf23ccd6e";
      fetchSubmodules = false;
      sha256 = "sha256-te/eAJlaZFQDSkuvCoXRqGJVHMmWGsrZJ/Oh0ISI+MI=";
    };
    date = "2025-06-01";
  };
  sad-nvim = {
